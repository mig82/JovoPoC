...
function IdentityService(konyRef, rec) {
	...
	this.refreshLogin = function(successCallback, failureCallback, options) {
		...
		if (kony.sdk.isNullOrUndefined(internalRefreshToken)) {
			...
			var urlObject = {[kony.sdk.constants.KEY_URL]: null};
			var headers = {};
			var bodyParams = {};
			var networkOptions = {};
...
kony.sdk.util.getRefreshLoginTokenStoreUtility = (function() {
    ...
    function refreshLoginTokenStoreUtility() {
         ...
         * @returns {JSON Object} - JSON Object containing all persisted login provider tokens
         */
         ...
         * @param {JSON Object} refreshLoginProviderTokensObject - JSON Object containing provider specific refresh tokens as key, value pairs
         */
         ...
         * @param {JSON Object} tokensData - JSON Object containing both backend and internal refresh tokens for the provided provider
         */
         ...
         * @returns {JSON Object} - JSON Object containing provider specific internal and backend refresh token
         */
